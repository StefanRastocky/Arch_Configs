#########################################
## ESTEFANO'S OWN QUTEBROWSER CONFIG FILE
#########################################
...
config.bind('w+', 'set tabs.width "c.tabs.width + 5"')
config.bind('sc', 'config-source ;; message-info "Sourcing"')
config.bind('ce', 'config-edit')
config.bind(',m', 'hint links spawn mpv --force-window=immediate --volume=30 --profile=720p --hwdec=opengl {hint-url}')
config.bind(',M', 'hint links spawn mpv --force-window=immediate --volume=30 --profile=1080p --hwdec=opengl {hint-url}')
config.bind(';M', 'spawn mpv --force-window=immediate --volume=30 --profile=best --hwdec=opengl {hint-url}')
config.bind(',b', 'hint links spawn addvideo {hint-url}')
...
# config.bind('w+', 'set tabs.width "c.tabs.width + 5"')
# config.bind('cs', 'config-source ;; message-info "Sourcing"')
# config.bind('ce', 'config-edit')
...
# config.bind(',m', 'hint links spawn mpv --force-window=immediate --volume=30 --profile=720p --hwdec=opengl {hint-url}')
# config.bind(',M', 'hint links spawn mpv --force-window=immediate --volume=30 --profile=best --hwdec=opengl {hint-url}')
# config.bind(';M', 'spawn mpv --force-window=immediate --volume=30 --profile=best --hwdec=opengl {url}')
